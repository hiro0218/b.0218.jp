...
根拠: `.claude/rules/components.md#-zero-margin-principle-critical`
...
根拠: `.claude/rules/components.md#-レイヤー依存関係-critical`
...
- 違反: `_article/_posts/*.md` への Edit/Write、`dist/**` や `public/images/ogp/**` の手動変更

  ...
  return (
    <>
      <Head>
        ...
        <meta content={SITE.DESCRIPTION} key="description" name="description" />
        <meta content="website" key="og:type" property="og:type" />
        <meta content={SITE.URL} key="og:url" property="og:url" />
        <meta content={SITE.NAME} key="og:title" property="og:title" />
        <meta content={SITE.DESCRIPTION} key="og:description" property="og:description" />
        <meta content={AUTHOR.ICON} key="og:image" property="og:image" />

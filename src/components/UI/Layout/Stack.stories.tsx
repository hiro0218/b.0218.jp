 ...
 *
 * @summary 要素を縦方向に均等な間隔で積みたいときの最小構成
 */
 ...
 *
 * @summary 密度の異なるレイアウトを設計するときの間隔基準を確認するために使用する
 */
...
/**
 * 横方向で配置を指定する。space-between でヘッダーレイアウト等に使用する。
 *
 * @summary 横方向で配置を指定する
 */
...
/**
 * 横方向で折り返しを有効にする。タグ一覧等の可変個数の要素に使用する。
 *
 * @summary 横方向で折り返しを有効にする
 */
...
/**
 * ul 要素として描画する。セマンティクスが必要なリストに使用する。
 *
 * @summary ul 要素として描画する
 */
 ...
 *
 * @summary 異なる高さの要素を横並びにしつつ、視線の高さを揃えたいときに使用する
 */
 ...
 *
 * @summary ダイアログのフッターやツールバーなど、主要操作を右端に固定したいときに使用する
 */

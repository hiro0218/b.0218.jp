...
const shadows: TokenValues<'shadows'> = {
  ...
  md: { value: '0 4px 8px var(--shadows-base), 0 0 1px var(--colors-gray-a-7)' },
  lg: { value: '0 8px 16px var(--shadows-base), 0 0 1px var(--colors-gray-a-7)' },
  xl: { value: '0 16px 24px var(--shadows-base), 0 0 1px var(--colors-gray-a-7)' },
  '2xl': { value: '0 24px 40px var(--shadows-base), 0 0 1px var(--colors-gray-a-7)' },
};
